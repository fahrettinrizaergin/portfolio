...
const About = () => {
  ...
  const skills = [
    { category: 'Frontend', items: ['React', 'Next.js', 'VueJS', 'Tailwind CSS'] },
    { category: 'Backend', items: ['ExpressJS', 'Laravel', 'NodeJS', 'Golang'] },
    { category: 'Database', items: ['MongoDB', 'PostgreSQL', 'MariaDB'] },
    { category: 'Tools', items: ['GitHub', 'Docker', 'Linux', 'Apache'] },
