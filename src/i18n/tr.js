export default {
  translation: {
    ...
    home: {
      ...
      others: {
        commits: { title: "Commitlerim", value: '2+' },
    ...
    about: {
      ...
      experiences: {
        ...
        experience_two: {
          title: 'Full Stack Developer',
          company: 'Freelancer',
          date: 'Ocak 2018 - Aralık 2020',
          description: 'Ben bir freelancer ve projelerimde ilgileniyorum.'
        },
      }
    },
    contact: {
      title: 'İletişim',
      description: 'Herhangi bir soru veya fırsat için benimle iletişime geçebilirsiniz!',
      name: 'İsim',
      email: 'E-posta',
      message: 'Mesaj',
      send: 'Mesaj Gönder'
    ...
    blogs: {
        ...
        title: "Bloglar",
        description: "Web geliştirme, programlama ve teknoloji hakkındaki deneyimlerim ve düşüncelerim hakkında yazıyorum.",
